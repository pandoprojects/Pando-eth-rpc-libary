...
var RootCmd = &cobra.Command{
	Use:   "pando-eth-rpc-adaptor",
	Short: "Pando ETH RPC Adaptor",
	Long:  `Pando ETH RPC Adaptor`,
}
...
func getDefaultConfigPath() string {
	...
	return path.Join(home, ".pando-eth-rpc-adaptor")
}
...
// The pandonet environment has the following 10 test accounts preloaded with PTX in the genesis
