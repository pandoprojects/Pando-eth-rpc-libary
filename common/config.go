...
const (
	...
	// CfgPandoRPCEndpoint configures the Pando RPC endpoint
	CfgPandoRPCEndpoint   = "pando.rpcEndpoint"
	CfgPandoBlockGasLimit = "pando.blockGasLimit"
...
func init() {
	...
	viper.SetDefault(CfgPandoRPCEndpoint, "http://127.0.0.1:16888/rpc")
	viper.SetDefault(CfgPandoBlockGasLimit, 20000000)
